...
const Footer = () => {
 ...
 <div className="hidden lg:block">
      <div class=" bg-[#026E5F] pt-5 h-[450px] ">
...
<div class="text-sm uppercase text-white font-bold">Resources</div>
      ...
      <div className="flex justify-center text-white bg-[#026E5F] pb-[28px]">   <p className="text-center">Terms & Conditions | Refund Policy | Privacy Policy <br/>
2023 naviea Technologies Bangladesh Ltd </p></div>
    </div>


<div className="block lg:hidden"><FooterTwo/></div>
