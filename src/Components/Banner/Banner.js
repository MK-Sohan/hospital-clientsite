         ...
         {/* ----------------------------------dropdown end -------------------- */}
          ...
          <div class="banner_right_side flex flex-col  gap-4 lg:flex-row  ">
            <div class="banner_sub_left_side  flex flex-col gap-3">
              <Link to='/doctors' class="banner_card w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#94bfb9b2]">
              ...
              <a href="#tabOne" to='/doctors' class="banner_card w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#FFEAEA]">
                <div class="banner_card_chield_img bg-white h-[80px] w-[80px] rounded-full flex justify-center items-center">
                  <img src={icon2} alt="" />
                </div>
                <div class="banner_card_details w-[70px] text-[22px] font-bold">
              ...
              <button onClick={toggleModal}  class="banner_card w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#94bfb9b2]">
                <div class="banner_card_chield_img bg-white h-[80px] w-[80px] rounded-full flex justify-center items-center ">
              ...
              <a href="#tabTwo" class="banner_card w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#FFEAEA]">
                <div class="banner_card_chield_img bg-white  h-[80px] w-[80px] rounded-full flex justify-center items-center">
                  <img src={icon4} alt="" />
                </div>
                <div class="banner_card_details w-[70px] text-[22px] font-bold">
...
{/* ======================= modal Container start============================== */}
            ...
            <button onClick={toggleModal} class="banner_card w-[300px] gap-x-5 h-auto flex  px-[20px] py-[20px] rounded items-center gap-3 bg-[#FFEAEA]">
...
{/* ======================= modal Container end============================== */}
              ...
              <a href="#telemedicine"   class="banner_card w-full max-w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#94bfb9e6]">
                <div class="banner_card_chield_img bg-white h-[80px] w-[80px] rounded-full flex justify-center items-center">
                  <img src={icon6} alt="" />
                </div>
                <div class="banner_card_details w-[70px] text-[22px] font-bold">
...
Nurse
              ...
              <a href="#findAmbulence"  class="banner_card w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#FFEAEA]">
                <div class="banner_card_chield_img bg-[#FFA8A8]  h-[80px] w-[80px] rounded-full flex justify-center items-center ">
                  <img className=" " src={icon3} alt="" />
                </div>
              ...
              <a href="#packages" class="banner_card w-[300px] h-auto flex justify-evenly px-[20px] py-[20px] rounded items-center gap-3 bg-[#94bfb9e6]">
                <div class="banner_card_chield_img bg-white h-[80px] w-[80px] rounded-full flex justify-center items-center">
                  <img src={icon1} alt="" />
                </div>
