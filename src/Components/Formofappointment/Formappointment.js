        ...
        <div className='mb-20 px-2 lg:px-0'>
          ...
          <div className="rating mt-[10px]">
           ...
           <div className='text-center'>
            <p className='font-[500] text-[24px] text-[#6C6C6C] '>Date : 3/19/2023</p>
            <p className='font-[500] text-[24px] text-[#6C6C6C] '>Time : 09:00am- 10:00am</p>
           </div>
...
<div className=''>
        <p className='font-[600] text-[20px] text-black'>Patient Information</p>
        <p className='font-[500] mt-4 text-[20px] text-black'>Patient Status</p>
    ...
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2 ">
            <div>
                <input placeholder='Name' id="username" type="text" class="block w-full px-4 py-2 mt-2
            ...
            <div>
            <div>
                 <input placeholder='Date of Birth' id="date" type="date" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border  rounded-md focus:outline-none "/>
            </div>
            </div>
            ...
            <div>
            <input placeholder='Phone Number' id="username" type="text" class="block w-full px-4 py-2 mt-2
                 text-gray-700 bg-white   rounded-md      focus:outline-none "/>
            </div>
            <div>
                
            <input placeholder='Email' id="username" type="email" class="block w-full px-4 py-2 mt-2
                 text-gray-700 bg-white   rounded-md      focus:outline-none "/>
            </div>
            {/* <div>
            ...
            <div>
                ...
                <textarea placeholder='write your message' id="textarea" type="textarea" class="h-[138px] block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none"></textarea>
            </div>
            <div>
 ...
 <p className='font-[500]  text-[20px] text-black' >Have you ever applied to our facility before?</p>
    <div className='flex items-center gap-x-6'>
        ...
        <div className="">
          <Link to='/OTTP' >
             <button className="bg-[#00A662] px-5 py-2 lg:py-0 lg:px-0 lg:w-[27.950000000000003vw] text-white lg:text-[1.2vw] font-[500] lg:h-[3.35vw] rounded-[40px] hover:bg-[#83d6b4] hover:text-gray-700 transition mt-[19px]">Get Appointment</button>
             </Link>
